...
class Fase13:
    def __init__(self, player):
        ...
        self.enemies = []  # Add this line to track enemies
    ...
    def initialize(self):
        ...
        self.tilemap = TileMap("Level1", "Level1_3.tmx")
        ...
        self.player1.set_position((3712, 192))
        ...
        self.all_sprites_group = pygame.sprite.Group(self.player1, self.bullets_group, self.bullet_counter, self.health_bar, self.items_group, self.coin_counter)
        ...
        # Create enemies instead of boss
        self.enemies_group = pygame.sprite.Group()
        # Spawn 4 enemies at different positions
        enemy_positions = [(3712, 300), (3500, 350), (3500, 250), (3500, 375)]
        for pos in enemy_positions:
            enemy = Enemy_lvl1(self.walls_sprites, "items/Coin.png", "items/coordCoin.txt", 10)
    ...
    def check_collisions(self):
        ...
        for bullet in self.bullets_group:
            # Get bullet's world coordinates
            bullet_world_rect = pygame.Rect(
                bullet.rect.x + self.scroll[0],
                bullet.rect.y + self.scroll[1],
                bullet.rect.width,
                bullet.rect.height
            )
            ...
            for enemy in self.enemies_group:
                if enemy.alive and bullet_world_rect.colliderect(enemy.get_world_hitbox()):
                    ...
                    if item:
                        # Ajustar la posición del item para que su centro coincida con el centro del enemigo
